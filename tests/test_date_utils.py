...
import pytz
from aiofix.utils.date_utils import is_dow_in_range, is_time_in_range, seconds_for_time_period
...
def test_seconds_for_period():
    ...
    seconds_to_start, end_datetime = seconds_for_time_period(
        datetime(2019, 1, 1, 6, 0, 0),
        time(8, 0, 0),
        time(16, 0, 0))
    assert seconds_to_start / 60 / 60 == 2
    ...
    seconds_to_start, end_datetime = seconds_for_time_period(
        ...
        time(8, 0, 0),
        time(16, 0, 0))
    assert seconds_to_start / 60 / 60 == 0
    assert end_datetime == datetime(2019, 1, 1, 16, 0, 0)
    ...
    seconds_to_start, end_datetime = seconds_for_time_period(
        ...
        time(8, 0, 0),
        time(16, 0, 0))
    assert seconds_to_start / 60 / 60 == 14
